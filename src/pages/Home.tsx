  ...
  return (
    <main className="page-shell flex min-h-[calc(100svh-3rem)] flex-col items-center justify-center py-8 text-center sm:min-h-[calc(100vh-5rem)] sm:py-14">
      <div className="flex flex-col items-center">
        ...
        <h1 className="mt-3 text-[2rem] font-semibold leading-tight tracking-[0.015em] text-chalk-100 sm:mt-4 sm:text-5xl sm:tracking-[0.03em] md:text-6xl">
          <span>Tensor</span>
          <span className="text-circuit-300">Tutors</span>
        </h1>
        <p className="mt-2 font-sans text-sm leading-6 text-chalk-200/75 sm:mt-3 sm:text-lg sm:leading-7">Understand Computer Science — fast.</p>
      </div>
